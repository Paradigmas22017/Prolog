...
raw_data = pd.read_csv('../Output/all_outputs.csv', usecols=['label', 'corpus'])
X = raw_data["corpus"]
y = raw_data["label"]
...
X_train_bw, X_test_bw, y_train_bw, y_test_bw = train_test_split(X_bow, y, test_size=0.60)
X_train_tf, X_test_tf, y_train_tf, y_test_tf = train_test_split(X_tfidf, y, test_size=0.60)
